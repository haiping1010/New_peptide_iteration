...
config['model_weight_filename'] = 'experiments/2021-10-07/LSTM_Chem/checkpoints/LSTM_Chem-22-0.56.hdf5'
...
finetuner.finetune()
finetuner.model.save_weights('experiments/2021-10-07/LSTM_Chem/checkpoints/finetuned_gen1.hdf5')

config = process_config('experiments/2021-10-07/LSTM_Chem/config.json')
##config['model_weight_filename'] = 'experiments/2019-12-23/LSTM_Chem/checkpoints/finetuned_gen' +'1.hdf5'
config['finetune_data_filename'] = './generated_data/retrain.fa'

config['model_weight_filename'] = 'experiments/2021-10-07/LSTM_Chem/checkpoints/finetuned_gen1.hdf5'
modeler = LSTMChem(config, session='generate')
generator = LSTMChemGenerator(modeler)
#print(config)
...
with open('./generations/gen_1.fa', 'w') as f:
