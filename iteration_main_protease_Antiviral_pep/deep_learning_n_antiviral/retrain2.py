...
config['finetune_data_filename'] = './generated_data/retrain2.fa'
#print(config)
...
import pandas as pd
training_data = pd.read_csv('./generated_data/retrain2.fa', header=None)
...
with open('./generations/gen_2.fa', 'w') as f:
