...
config['finetune_data_filename'] = './generated_data/retrain4.fa'
#print(config)
...
finetuner.finetune()
finetuner.model.save_weights('experiments/2021-10-07/LSTM_Pep/checkpoints/finetuned_gen4.hdf5')

config = process_config('experiments/2021-10-07/LSTM_Pep/config.json')
##config['model_weight_filename'] = 'experiments/2019-12-23/LSTM_Pep/checkpoints/finetuned_gen' +'1.hdf5'
config['finetune_data_filename'] = './generated_data/retrain4.fa'

config['model_weight_filename'] = 'experiments/2021-10-07/LSTM_Pep/checkpoints/finetuned_gen4.hdf5'
modeler = LSTMChem(config, session='generate')
generator = LSTMChemGenerator(modeler)
#print(config)
...
import pandas as pd
training_data = pd.read_csv('./generated_data/retrain4.fa', header=None)
...
with open('./generations/gen_4.fa', 'w') as f:
